...
//QApplication::setStyle(QStyleFactory::create("android"));
    ...
    //QMainWindow->setStyleSheet("QWidget { border-image: url(:/images/back1); }");
    //overviewPage->setStyleSheet(  "border-image: url(:images/back1);");

    //centralWidget->setStyleSheet("border-image: url(:images/back1);");

    //qApp->setStyleSheet("QWidget { border-image: url(:images/back1); }");
    //qApp->setStyleSheet("QWidget { border-image: url(:images/back1); }");
...
*/
    ...
    //syncIconMovie = new QMovie(fUseBlackTheme ? ":/movies/update_spinner_black" : ":/movies/update_spinner", "GIF", this);
    syncIconMovie = new QMovie(":/movies/update_spinner_black", "GIF", this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setIconSize(QSize(90, 90));
    //toolbar->setContextMenuPolicy(Qt::PreventContextMenu);
 //   toolbar->setMaximumWidth(110); //
...
/*    if (fUseBlackTheme)
    {
        ...
        header->setMinimumSize(100, 100);
        header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        header->setStyleSheet("QWidget { background-color: #000000; background-repeat: no-repeat; background-image: url(:/images/header3); }");
...
/*
//Vertical Footer
    QWidget* footer1 = new QWidget();
    footer1->setMinimumSize(90, 240);
    footer1->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    footer1->setStyleSheet("QWidget { background-color: #000000; background-repeat: no-repeat; background-image: url(:/images/footer1); }");
    toolbar->addWidget(footer1);
*/
/*
//Horizontal Footer
    QWidget* footer2 = new QWidget();
    footer2->setMinimumSize(240, 90);
    footer2->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    footer2->setStyleSheet("QWidget { background-color: #000000; background-repeat: no-repeat; background-image: url(:/images/footer2); }");
    toolbar->addWidget(footer2);
*/
...
{
    QMessageBox::warning(this, tr("Connection Information"), tr("%1 active connection(s) to Rpicoin network").arg(countStatus01));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(tr(clientModel->isImporting() ? "Importing blocks..." : "Syncing with network..."));
...
void BitcoinGUI::updateButtonStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        buttonStakingIcon->setIcon(QIcon(fUseBlackTheme ? ":/icons/rpicoin/staking_on" : ":/icons/staking_on"));
    ...
    {
        buttonStakingIcon->setIcon(QIcon(fUseBlackTheme ? ":/icons/rpicoin/staking_off" : ":/icons/staking_off"));
        buttonStakingIcon->setIconSize(QSize(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        buttonStakingIcon->setStyleSheet("border: none;background-color: rgba(0,0,0,0);");
        if (pwalletMain && pwalletMain->IsLocked())
