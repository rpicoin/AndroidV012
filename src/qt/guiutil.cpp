...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: #383435; color: #c95353; }"
                      ...
                      //"QToolButton    { background-color: #000000; color: #c95353; border: none; }"
                      //"QToolButton:checked { background-color: #383435; color: #c95353; }"
                      //"QToolBar       { background-color: #000000; #c95353; border: none; }"

                      "QToolButton    { background: #000000; color: #ffffff; border: 0px; }"
                      "QToolButton:checked { background: #383435; color: #c95353; border: 0px; border-radius: 15px; }"
                      "QToolBar       { background: #000000; color: #ffffff; border: 0px; }"



                      //"QMainWindow    { border-image: url(:/images/header); }"
                      //"QStackedWidget { border-image: url(:images/header); }"

                      //red fusion
//                      "QWidget#OverviewPage        { background: qlineargradient(x1:1, y1:1, x2:0, y2:0, stop:0 #000000, stop:1 #383435; }"

                      //"QWidget#OverviewPage { background-image: url(:images/back1); background-repeat: no-repeat; background-position: center; }"

//                      "QWidget#widget_2 { background-color: rgba(0,0,0,0); }"
//                      "QWidget#widget { background-color: rgba(0,0,0,0); }"

//                      "QLabel#labelAlerts, #label_5, #labelWalletStatus, #labelImmatureText,#label_6, #label, #labelStake, #labelUnconfirmed, #labelBalance, #label_3, #labelImmature, #labelTotalText, #labelTotal, #label_4, #labelTransactionsStatus { background-color : rgba(0,0,0,0); }"
...
//                      //"QLabel         { background-color: rgba(0,0,0,10); color: #ffffff; }"


//                      //"QListView#listTransactions { background-color: rgba(0,0,0,100); }"
...
//                      "QToolButton    { background: #000000; color: #ffffff; border: none; margin: 5px; padding: 3px 1px 5px 2px; border-left-style: solid; border-left-width: 1px; border-left-color: #000000; }"
